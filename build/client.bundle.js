...
console.log("priv")
canvas.addEventListener("touchstart", (e)=> { touchStarted(e)})
canvas.addEventListener("touchend", (e)=> { setButton('left', false)})
...
function touchStarted(e) {
  ...
  // let myHypot = Math.hypot(x - cell.x, y - cell.y);
  // cell.velocity = myHypot / 1000;

  // cell.sin = (cell.y - y) / myHypot;
  // cell.cos = (cell.x - x) / myHypot;
  // console.log(String(cell.cos ))    
  // priv.innerHTML = (`${cell.x},  ${cell.y}`)
